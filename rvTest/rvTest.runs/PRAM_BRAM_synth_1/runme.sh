...
HD_PWD='/home/vessel/SEU-RISCV-CPU/rvTest/rvTest.runs/PRAM_BRAM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PRAM_BRAM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PRAM_BRAM.tcl
