...
set cached_ip [config_ip_cache -export -no_bom -use_project_ipc -dir /home/vessel/rvTest/rvTest.runs/cpuclk_synth_1 -new_name cpuclk -ip [get_ips cpuclk]]
...
if { [catch {
  file copy -force /home/vessel/rvTest/rvTest.runs/cpuclk_synth_1/cpuclk.dcp /home/vessel/rvTest/rvTest.srcs/sources_1/ip/cpuclk/cpuclk.dcp
} _RESULT ] } { 
...
if { [catch {
  write_verilog -force -mode synth_stub /home/vessel/rvTest/rvTest.srcs/sources_1/ip/cpuclk/cpuclk_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode synth_stub /home/vessel/rvTest/rvTest.srcs/sources_1/ip/cpuclk/cpuclk_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_verilog -force -mode funcsim /home/vessel/rvTest/rvTest.srcs/sources_1/ip/cpuclk/cpuclk_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode funcsim /home/vessel/rvTest/rvTest.srcs/sources_1/ip/cpuclk/cpuclk_sim_netlist.vhdl
} _RESULT ] } { 
...
if { [catch {
  file rename -force /home/vessel/rvTest/rvTest.runs/cpuclk_synth_1/cpuclk_stub.v /home/vessel/rvTest/rvTest.srcs/sources_1/ip/cpuclk/cpuclk_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force /home/vessel/rvTest/rvTest.runs/cpuclk_synth_1/cpuclk_stub.vhdl /home/vessel/rvTest/rvTest.srcs/sources_1/ip/cpuclk/cpuclk_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force /home/vessel/rvTest/rvTest.runs/cpuclk_synth_1/cpuclk_sim_netlist.v /home/vessel/rvTest/rvTest.srcs/sources_1/ip/cpuclk/cpuclk_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  file rename -force /home/vessel/rvTest/rvTest.runs/cpuclk_synth_1/cpuclk_sim_netlist.vhdl /home/vessel/rvTest/rvTest.srcs/sources_1/ip/cpuclk/cpuclk_sim_netlist.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the VHDL functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}
...
if {[file isdir /home/vessel/rvTest/rvTest.ip_user_files/ip/cpuclk]} {
  catch { 
    file copy -force /home/vessel/rvTest/rvTest.srcs/sources_1/ip/cpuclk/cpuclk_stub.v /home/vessel/rvTest/rvTest.ip_user_files/ip/cpuclk
  }
}

if {[file isdir /home/vessel/rvTest/rvTest.ip_user_files/ip/cpuclk]} {
  catch { 
    file copy -force /home/vessel/rvTest/rvTest.srcs/sources_1/ip/cpuclk/cpuclk_stub.vhdl /home/vessel/rvTest/rvTest.ip_user_files/ip/cpuclk
  }
}
