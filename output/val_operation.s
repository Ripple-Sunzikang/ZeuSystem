...
eq_done203:
lw a1, 36(sp)
beq a1, zero, and_false204
beq a0, zero, and_false204
addi a0, zero, 1
j and_done205
and_false204:
addi a0, zero, 0
...
eq_done207:
lw a1, 36(sp)
beq a1, zero, and_false208
beq a0, zero, and_false208
addi a0, zero, 1
j and_done209
and_false208:
addi a0, zero, 0
and_done209:
beq a0, zero, else_198
li a0, 100000
sw a0, 36(sp)
nop
lw a0, 36(sp)
